class TexturesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to textures_path, status: :see_other, notice: "Texture was successfully destroyed." }
  ...
  private
    ...
    def set_texture
      @texture = Texture.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def texture_params
      params.expect(texture: [ :name, :url, :sizePixelsX, :sizePixelsY ])
    end
end
