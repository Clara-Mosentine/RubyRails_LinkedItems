...
class TexturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create texture" do
    assert_difference("Texture.count") do
      post textures_url, params: { texture: { name: @texture.name, sizePixelsX: @texture.sizePixelsX, sizePixelsY: @texture.sizePixelsY, url: @texture.url } }
    end
  ...
  test "should update texture" do
    patch texture_url(@texture), params: { texture: { name: @texture.name, sizePixelsX: @texture.sizePixelsX, sizePixelsY: @texture.sizePixelsY, url: @texture.url } }
